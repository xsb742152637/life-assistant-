package com.xie.lifeassistant.model.core.guidefile.service.core;
...
public class MenuEx extends Comm{
    ...
    @Lazy
    @Autowired
    public CoreGuideFileService fileService;
    ...
    public void addMemByMenu(String projectId, String menuId, Set<String> memberIds, String sourceType){
        ...
        fileService.deleteById(projectId);
        fileService.save(projectId,menuEntity.getContext());
    ...
    public void updateGuideByMemChange(String memberId, String sourceType){
